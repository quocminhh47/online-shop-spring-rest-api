    ...
    <script type="text/javascript">
        ...
        function insertProduct(){
            ...
            $.ajax({
                ...
                type:"POST",
                url:"http://localhost:8080/admin/api/product/insert-product",
                ...
                success: function (notification) {
                    ...
                    else {alert("Insert failed, try again");}
                },
            ...
            <div class="signup-content">
                ...
                <div class="signup-form">
                    ...
                    <div class="form-submit">
                            <input type="submit" value="Insert" class="submit" onclick="insertProduct()" id="submit" name="submit" />
